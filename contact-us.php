...
<head>
    ...
    <title>Vyas Veggies Home To Home Food Delivery | Contact us</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone +91 6378300549</p>
                                                <p itemprop="description">Phone +91 7976363986</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Near Vrshman Girls College</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
