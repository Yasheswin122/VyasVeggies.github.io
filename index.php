...
<head>
    ...
    <title>Vyas Veggies Home To Home Food Delivery</title>
...
<?php include_once('includes/header.php');?>
        ...
        <section>
            <div class="block blackish opac50">
                <div class="fixed-bg" style="background-image: url(assets/images/vvv-01.jpg);"></div>
                <div class="restaurant-searching style2 text-center">
                    <div class="restaurant-searching-inner">
						<span>Delicious <i>Food</i> </span>
                        <h2 itemprop="headline">Order Delivery & Take-Away</h2>
