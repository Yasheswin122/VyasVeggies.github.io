...
<head>
    ...
    <title>Vyas Veggies Home To Home Food Delivery | Food Details</title>
        ...
        <div class="bread-crumbs-wrapper">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" style="margin-top: -20px">My Cart</li>
                </ol>
            </div>
        </div>
...
<tr>
  ...
  <!--<img src=".\assets\images\suc.gif" alt="success GIF" width="100%">-->
<?php } else {?>
    <tr>
